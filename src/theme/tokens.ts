...
export const softTheme: ThemeTokens = {
  ...
  poleColors: {
    ...
    finance: { solid: '#7F9A5B', layers: ['#C2D3A5', '#7F9A5B', '#5C7340'], on: '#F6F9EF' },
    home: { solid: '#D2A23C', layers: ['#EAD08A', '#D2A23C', '#A87C28'], on: '#1A0708' },
    learning: { solid: '#5C8597', layers: ['#A9C2CC', '#5C8597', '#3E606E'], on: '#F6F9EF' },
    relationships: { solid: '#E0A0C8', layers: ['#F2CFE3', '#E0A0C8', '#C277A0'], on: '#1A0708' },
    leisure: { solid: '#9C6BA6', layers: ['#CBA9D0', '#9C6BA6', '#6F4878'], on: '#F6F9EF' },
  },
